...
BASE=${BASE:?缺 BASE —— 用 make test STACK=qwen38fn}
MODEL=${MODEL:?缺 MODEL —— 用 make test STACK=qwen38fn}
...
if calls:
    ...
    print("      qwen3_coder(stacks/qwen38fn/recipe.yaml 与 ConfigMap 成对改)。")
PY
